    ...
    <div class="container">
        ...
        <?php
            $mysqli = new mysqli("localhost", "root", "", "LiveSummaryDb");
             ...
             $id = $_GET['id'];
             $sql = "SELECT * FROM articles WHERE unit_title='$id'";
             $result = $mysqli->query($sql);
             $mysqli->close();

        ?>
        <section id="BodyContainer">
            <h2 style="margin-top:80px;text-align:center;background-color:rgb(0,0,0,10);"><?php echo $id?></h2>
            <div class="body-con" style="margin-top:20px;">    
